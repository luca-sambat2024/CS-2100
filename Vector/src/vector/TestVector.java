...
public static int NUM_TESTS = 500;
	...
	public static void main(String[] args) {
		Vector<Integer> test=new Vector<Integer>(20); //test cases for a custom vector
		for(int i=0; i<20; i++) {
			int rand = (int) Math.floor(Math.random() * 20);
			test.insertAtTail(rand);
		}
		System.out.println(test+" "+test.size()+" "+test.capacity());
		test.resize(5);
		System.out.println(test+" "+test.size()+" "+test.capacity());
		test.insertAt(10,-1);
		System.out.println(test+" "+test.size()+" "+test.capacity());
		...
		LinkedList<Integer> compList = new LinkedList<Integer>();
...
//		System.out.println(compList.size()+" "+studList.size());
		compList.add(550,999999);
		studList.insertAt(550,999999);
		System.out.println(compList+"\n"+studList);
		System.out.println("Done. Looks good");
...
//			System.out.println(ind1+"\n"+ind2);
		...
		compList.clear();
		studList.clear();
		System.out.println(compList+" "+studList);
		if(!(compareLists(compList, studList))) {
